...
from network.informer_utils.masking import TriangularCausalMask, ProbMask
...
class ProbAttention(nn.Module):
    ...
    def forward(self, queries, keys, values, attn_mask):
        ...
        # print(scores_top.squeeze(0).squeeze(0).shape)
        return context.contiguous(), scores_top.squeeze(0).squeeze(0)
